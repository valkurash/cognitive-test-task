function drawNestedSetsTree(data, node) {
    ...
    function handleNode(node, previousLeft, set) {
        ...
        if (node.tagName === 'UL') {
            ...
            Array.prototype.forEach.call(node.childNodes, child => { lastRight = handleNode(child, lastRight, set); });
            return lastRight;
        }
        var indexed = {};
        set.push(indexed);
...
const data2 = [
    ...
    { title: "Мужская", left: 2, right: 21 },
    { title: "Костюмы", left: 3, right: 14 },
    { title: "Жакеты", left: 4, right: 5 },
    { title: "Брюки", left: 6, right: 7 },
    { title: "Платья", left: 8, right: 13 },
    { title: "Летние", left: 9, right: 10 },
    { title: "Вечерние", left: 11, right: 12 },
    { title: "Женская", left: 15, right: 20 },
    { title: "Юбки", left: 16, right: 17 },
    { title: "Блузы", left: 18, right: 19 }
